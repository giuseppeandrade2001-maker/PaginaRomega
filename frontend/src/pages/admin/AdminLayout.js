...
import { LayoutDashboard, Newspaper, Files, Mail, LogOut, UserCheck, Users, Image as ImageIcon } from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const navs = [
    ...
    { name: 'Directorio', path: '/admin/directorio', icon: Users },
